...
$Y_g$, $X_t$, and $Y_j$. Here, we obtain a list of lists for the two genes.
...
either chromatin accessibility, $X_t$,
or TF expression, $Y_j$.
In either case, two tests with different stringency are performed (level 1 and 2).
...
Here, for brevity, we only show the code for TRIPOD level 1 and 2 matching $X_t$.
