...
This is a supplement to [the TRIPOD vignette for the 10x Genomics mouse embryonic brain data](http://htmlpreview.github.io/?https://github.com/yharigaya/TRIPOD/blob/main/vignettes/TRIPOD_e18.html).
...
`"/path/to/your/hdf5/file"` needs to be replaced with
...
peakxmotif <- tripod.e18$peakxmotif.gr
```
...
```{r, eval = TRUE, message = FALSE, warning = FALSE}
res <- 15
e18 <- getClusters(object = e18, graph.name = "wsnn", algorithm = 3,
...
metacell.color <- color.e18$metacell$color
```
